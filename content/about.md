...
Lax is an open archive for mathematics formalized in Lean. It presents the appropriate surface of definitions and statements for review, and records the checked proofs and assumptions behind them.
