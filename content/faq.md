...
such as treewidth, the RAM model, game semantics, or an orbifold. Following
submissions can import it instead of reformalizing it and asking the community
to vet the same definition again.
...
Run Lax from the corresponding project directory. This keeps each submission's
manifest and working tree independent while sharing the toolchain.
