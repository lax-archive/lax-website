...
${sourceLines ? `<fieldset class="flag-line-fields"><legend>Optional source annotation</legend><p>Select a range here or choose it directly from the numbered Lean source.</p><div class="flag-line-inputs"><label>Start line <input type="number" inputmode="numeric" min="1" max="${sourceLines}" data-flag-line-start></label><label>End line <input type="number" inputmode="numeric" min="1" max="${sourceLines}" data-flag-line-end></label></div><button class="secondary-button" type="button" data-flag-line-picker>Select lines from source</button><p class="flag-line-selection" data-flag-line-selection aria-live="polite"></p></fieldset>` : ""}
