...
\end{enumerate}
The kernel can handle \ref{it:1} and \ref{it:3}, while \ref{it:2} can be done by meta-programming (\verb|#print axioms|).
This way you would be reproducing\footnote{Note that the used Mathlib, Lean, and Lake versions are part of the submission metadata.} the relevant subset of our submission pipeline, and we would be progressively earning your trust.
...
The next important feature that we will integrate to the website is the option to vouch that a~declaration is formalized correctly, that is, faithful to the mathematical intent.
