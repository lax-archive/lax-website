...
\begin{itemize}
\item a command-line interface \href{https://www.npmjs.com/package/lax-archive}{\textsf{lax-CLI}}, which primarily allows to submit new entries,
...
\item a \href{https://laxarchive.org/}{website}, which allows to browse these submissions.
\end{itemize}
...
\end{itemize}
At present, \href{https://lean-lang.org/}{Lean} is the only supported language for the submissions, the `l' of lax stands for Lean, and `ax' for \textbf{a}r\textbf{ch}ive.
...
Every axiom statement accompanied by a~proof (in the proof package) is marked as proven (\laxthm) on the website.
...
2026 was the year when frontier AI agents unlocked the ability of fully autonomously translating natural-language proofs, however long they were, into Lean.
Consequently, at a~small (and ever smaller) cost, and at the time of telling your agent which result you want formalized next, you very likely get your wish granted.   
Still, once you thus get a~Lean proof of, say, your latest result, why not stopping there?
...
If the axiom of a~concept appears as proven on the website (green background or \laxthm), should I trust that the corresponding proof package actually proves it?
Assuming you already believe in the soundness of Lean's kernel, you have to further trust us on  
\begin{itemize}
\item the submission pipeline,
\item the validity 
\item the integrity of the database.
\end{itemize}
