...
After the formula.`, "");
  ...
  it("renders the submission page: paper masthead, compact grids, citation, graph data", async () => {
    ...
    expect(html).toContain('data-reaction="like"');
    expect(html).toContain('data-reaction="dislike"');
    expect(html).toContain('data-reaction="rocket"');
    expect(html).toContain('data-reaction-voters="like"');
    expect(html).toContain('data-reaction-voters="dislike"');
    expect(html).toContain('data-reaction-voters="rocket"');
