...
After the formula.`, "");
  ...
  it("renders the concept page: type heading, tinted source, sections, deps", async () => {
    ...
    expect(html).toContain('data-flag-line-start');
    expect(html).toContain('data-flag-line-end');
    expect(html).toContain('data-flag-line-picker>Select lines from source');
