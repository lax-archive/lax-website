...
\[\frac{a}{b}\]
  ...
  it("renders the index with library rows and a searchable sidebar", async () => {
    ...
    expect(index).toContain('<section class="landing-workshop-banner" aria-labelledby="landing-workshop-banner-title">');
    expect(index).toContain('<h2 id="landing-workshop-banner-title">Lean and Lax online workshop</h2>');
    expect(index).toContain('href="workshop/">View workshop');
    expect(index).toContain("No Lean knowledge needed");
